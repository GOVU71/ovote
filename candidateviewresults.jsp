...
<li class="scroll-to-section"><a href="candidate.html">LogOut</a></li> 
	...
	<tr><td align="center" colspan=6> Election Results</td></tr>
<tr><th>Candidate Name</th><th>Party</th><th> constituency</th><th>District</th><th>State</th><th>Number of Votes</th></tr>
<%@include file="DBConn.jsp" %>
<%
 
PreparedStatement pst1=con.prepareStatement("select * from winners");
...
%>
<tr><td align="center" colspan=6><a href="candidatehome.jsp">Back</a></td></tr>
				</table>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <h3 style="text-align:justify">The main objective of Online Voting System is to provide is an alternative voting channel toincrease voter participation, reduce election costs while upholding the highest security, verifiability and integrity standards.</h3>
<h3>
</h3>
                    </div>
                </div>
