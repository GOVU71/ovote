...
<li class="scroll-to-section"><a href="candidate.html">LogOut</a></li> 
   ...
   <div class="main-banner" id="top" style="background-image: url('assets/images/OIP.jpg'); background-size: cover">
	...
	<tr><th> Live Voting</tH></tr>
<%@include file="DBConn.jsp" %>
<%
  String cname=(String)session.getAttribute("Name");
  PreparedStatement pst=con.prepareStatement("select * from elections where cname=?");
  pst.setString(1,cname);
  ResultSet rs=pst.executeQuery();
  rs.next();
  String cons=rs.getString(4);
  PreparedStatement pst1=con.prepareStatement("select * from elections where Constituency=?");
  ...
  {%>
	 ...
	 <tr><td align="center">Constituency=<%= rs.getString(4) %></td></tr>
	 <tr><td align="center">District=<%= rs.getString(5) %></td></tr>
	 <tr><td align="center">State=<%= rs.getString(6) %></td></tr>
	 <tr><td align="center">Number of Votes Registered =<%= rs1.getString(7) %></td></tr>
  <%}
  else
  {
	   out.println("<tr><Th>Sorry , No records found</th></tr>");
  }
%>
<tr><Th><a href="candidatehome.jsp">Back</a></th></tr>
				</table>
			       </div>
        </div>
    </div>
