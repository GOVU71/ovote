...
<tr><td align="center" colspan=2>Declare Results</td></tr>
<%@include file="DBConn.jsp" %>

<tr><td>Constituency</td><td><select name="constituency">
<%
  PreparedStatement pst=con.prepareStatement("Select constitiency from constituency");
...
<tr><td>State</td><td><select name="state">
  <%
  PreparedStatement pst2=con.prepareStatement("Select state from constituency");
...
<tr><td><input type="submit" value="View Voting Details" /></td>
