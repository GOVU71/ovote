...
<li class="scroll-to-section"><a href="candidate.html">Candidate</a></li>
  <li class="scroll-to-section"><a href="voter.html">Voter</a></li>
...
<form action="uploadFile1.jsp?id=<%= id %>" method="post" name="upform"  enctype="multipart/form-data">
                    <p align="center"><b>
       <font face="Trebuchet MS" size="6" color="#0CBEAC">Upload IDProof</font></b></div>
