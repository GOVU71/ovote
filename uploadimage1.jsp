...
<form action="uploadFile2.jsp?id=<%= id %>" method="post" name="upform"  enctype="multipart/form-data">
                    <p align="center"><b>
       <font face="Trebuchet MS" size="6" color="#0CBEAC">Upload Educational Proof</font></b></div>
